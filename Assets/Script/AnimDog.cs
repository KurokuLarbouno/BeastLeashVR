...
public class AnimDog : MonoBehaviour
{
    ...
    private float actLength = 0.4f, runLength = 2.0f;
    ...
    void FixedUpdate()
    {
        ...
        if (tarLength > actLength) transform.rotation = Quaternion.Lerp(transform.rotation, convertRot, chaseTimer);
        ...
        //移動
        //if (tarLength > actLength) transform.Translate(new Vector3(0, 0, playerSp * Time.deltaTime), Space.Self);
    }
